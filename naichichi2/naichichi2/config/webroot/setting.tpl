...
<div data-role="page" id="top" data-url="top" tabindex="0" class="ui-page ui-body-c ui-page-active">
	...
	<p><a data-role="button" class="menubutton" data-inline="true">設定→</a><a data-role="button" class="menubutton" data-inline="true">機材設定</a></p>

	<p><a data-role="button" data-transition="slide" href="#setting_account" >アカウント設定</a></p>
<!--	<p><a data-role="button" data-transition="slide" href="#setting_network" >ネットワーク設定</a></p> -->
	<p><a data-role="button" data-transition="slide" href="#setting_recong" >音声認識設定</a></p>
	<p><a data-role="button" data-transition="slide" href="#setting_speak" >合成音声設定</a></p>
	<p><a data-role="button" data-transition="slide" href="#setting_version" >バージョン情報</a></p>
...
<div data-role="header"> 
	...
	<dd>
		<span id="version">version</span><br>
		<input type="text" value=""> <a data-role="button" onclick="" >アップデートする</a>
	</dd>
	<dt>センサー</dt>
	<dd>
		<table id="sensor">
			<tr>
				<th>光センサー</th>
				<td id="sensor_lumi">700</td>
				<td>0～1000の値を取ります。<br />1000に近づくと明るくなります。</td>
			</tr>
			<tr>
				<th>温度センサー</th>
				<td id="sensor_temp">20.12</td>
				<td>摂氏-10～40度の値を取ります。<br />一般的なセルシウス度（摂氏度）です。</td>
			</tr>
		</table>
	</dd>
	<dt>APIキー</dt>
	<dd>
		APIキーは家電を他のアプリケーションから操作できるようにするキーです。大切にしてね<br />
		<span>APIキー</span>
	</dd>
	<dt>著作表示</dt>
	<dd>
