 ...
 * 
 * <JA>
 * @brief  ｲｻﾀｼﾇﾈｷﾁ､ｫ､・MFCC ﾆﾃﾄｧﾎﾌ､ﾘﾊﾑｴｹ､ｹ､・ﾈｯﾏﾃﾃｱｰﾌ)
 *
 * ､ｳ､ｳ､ﾇ､ﾏｲｻﾀｼﾇﾈｷﾁﾁｴﾂﾎ､ｱｰﾌ､ﾈ､ｷ､ﾆ MFCC ･ﾙ･ｯ･ﾈ･・ﾏﾎﾘﾊﾑｴｹ､ｹ､・ﾘｿｬﾄ・ﾁ
 * ､ｵ､・ﾆ､､､ﾞ､ｹ｡･･ﾕ･・ｼ･狹ｱｰﾌ､ﾇﾃ・ﾐ､ﾔ､ｦｴﾘｿﾏ wav2mfcc-pipe.c ､ﾋ
 * ｵｭｽﾒ､ｵ､・ﾆ､､､ﾞ､ｹ
 * 
 * ､ｳ､ｳ､ﾇﾃ・ﾐ､ﾇ､ｭ､・ﾎ､ﾏ MFCC[_0][_E][_D][_A][_Z] ､ﾎｷﾁｼｰ､ﾇ､ｹ｡･
 * </JA>
 * 
 * <EN>
